<?php get_comp('head'); ?>
<article>
    <h1 class="mb60">Creating your First Application</h1>
    <p>All you need to do is create a directory inside <span class="define">COREPATH</span>/apps/</p>
    <p>If your domain is wifipro.com, <b>wifipro</b> should be your directory inside apps (Irrespective of domain TLD)</p>
    ...
    <div class="mb60"></div>
    <h3>Domain to App (Automatic Detection)</h3>
