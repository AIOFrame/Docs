...
render_docs([
    ['h1','Database'],
    ['p',"Once you provide database hostname, database name, database user and password in <a href='".APPURL."setup/config'>app config</a>"],
...
// TODO: Write docs about automating tables
docs_nav();
get_comp('foot');